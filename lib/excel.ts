...
export async function parseWorkbook(file:File):Promise<ImportedSheet[]>{
  ...
  for(const sheet of wb.worksheets){
    if(sheet.rowCount>501||sheet.columnCount>60)continue;
